...
icl /I%PSDKPath%\Include /GR /GX /EHa ..\src\BGBase.cpp ..\src\BGString.cpp ..\src\FileCache.cpp ..\_TitanRes-MSVC2005\_TitanRes.cpp /Fe_titanRes /link comdlg32.lib kernel32.lib 
